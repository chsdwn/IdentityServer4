...
namespace IdentityServerHost.Quickstart.UI
{
    ...
    public class AccountController : Controller
    {
        ...
        public AccountController(
            ...
            ICustomUserRepository userRepo)
        {
        ...
        public async Task<IActionResult> Login(LoginInputModel model, string button)
        {
            ...
            if (ModelState.IsValid)
            {
                ...
                if (await _userRepo.ValidateAsync(model.Email, model.Password))
                {
                ...
                await _events.RaiseAsync(new UserLoginFailureEvent(
                    model.Email, "invalid credentials", clientId: context?.Client.ClientId));
